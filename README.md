# :earth_asia: **csdvr** :earth_americas: #  
 ...
 `csdvr` summarizes `calsim` output in [R](https://www.r-project.org/) | analyze large numbers of variables or scenarios | batch export plots (jpg, interactive [html](https://plot.ly/r/), pdf, etc) |
 
[calsim](https://water.ca.gov/Library/Modeling-and-Analysis/Central-Valley-models-and-tools/CalSim-2) is an application of a california water resources planning model developed jointly by [usbr](https://www.usbr.gov/) and [ca-dwr](https://water.ca.gov/) to help analyze limitations and possibilities of, and benefits and impacts from, the interconnected [central valley project](https://www.usbr.gov/mp/cvp/) and [state water project](https://water.ca.gov/Programs/State-Water-Project), under existing and alternative infrastructure, regulatory, operational, and climate scenarios.   calsim also helps answer other engineering and scientific questions and is common input to biologic, economic, groundwater, and hydrodynamic models. `csdvr` is tailored for CalSimII output; calsim 3.0 is still [beta](https://water.ca.gov/Library/Modeling-and-Analysis/Central-Valley-models-and-tools/CalSim-3)
