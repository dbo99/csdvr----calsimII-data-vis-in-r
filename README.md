...
[calsim](https://water.ca.gov/Library/Modeling-and-Analysis/Central-Valley-models-and-tools/CalSim-2) is a california water resources planning model application developed jointly by [usbr](https://www.usbr.gov/) and [ca-dwr](https://water.ca.gov/) to help analyze limitations and possibilities of, and benefits and impacts from, the interconnected [central valley project](https://www.usbr.gov/mp/cvp/) and [state water project](https://water.ca.gov/Programs/State-Water-Project), under existing and alternative infrastructure, regulatory, operational, and climate scenarios.   calsim also helps answer other engineering and scientific questions and is common input to biologic, economic, groundwater, and hydrodynamic models. [CalSim 3.0](https://water.ca.gov/Library/Modeling-and-Analysis/Central-Valley-models-and-tools/CalSim-3) is beta available now
