# :earth_asia: **csdvr** :earth_americas: #  
 ...
 [calsim]( https://water.ca.gov/Library/Modeling-and-Analysis/Central-Valley-models-and-tools/CalSim-2) data visualizer (post-processor) in [R](https://www.r-project.org/) | analyze calsim output for large numbers of variables or scenarios | export plots (jpg, interactive [html](https://plot.ly/r/), pdf, etc) |
