# :earth_asia: **csdvr** :earth_americas: #  
 ...
 `csdvr` summarizes `calsim` output in [R](https://www.r-project.org/) | quickly visualize the output distribution (including large numbers of scenarios) or export plots in batches (jpg, interactive [html](https://plot.ly/r/), pdf, etc) 
