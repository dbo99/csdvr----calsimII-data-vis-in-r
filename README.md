# :earth_asia: **csdvr** :earth_americas: #  
 ...
 `csdvr` summarizes `calsim` output in [R](https://www.r-project.org/) | it helps analyze large numbers of variables or scenarios and exports plots in batches (jpg, interactive [html](https://plot.ly/r/), pdf, etc) 
