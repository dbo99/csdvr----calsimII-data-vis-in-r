...
**Open RStudio and files** by clicking on **[`control.r`](https://github.com/dbo99/csdvr----calsimII-data-vis-in-r/blob/Aug15/control.R)**, then open  **`csv_list.r`** and **`scen_facts.r`**
