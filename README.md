...
#### notes #####
- assumes you know names of variables to search for, ie names of dvs, eg "s17". if not, dss records reveal names conveniently. wish-list: auto-completion of dv names while typing. `varcodes.csv` identifies some
