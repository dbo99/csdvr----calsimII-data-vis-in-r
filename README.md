# :earth_asia: **csdvr** :earth_americas: #  
 ...
 [calsim]( https://water.ca.gov/Library/Modeling-and-Analysis/Central-Valley-models-and-tools/CalSim-2) data visualizer (post-processor) in [R](https://www.r-project.org/) | analyze calsim output for large numbers of variables or scenarios | export plots (jpg, interactive [html](https://plot.ly/r/), pdf, etc) | calsim is a california water resources planning model application developed jointly by [usbr](https://www.usbr.gov/) and [ca-dwr](https://water.ca.gov/) to help analyze limitations, possibilities of, and benefits and impacts from, the interconnected [central valley project](https://www.usbr.gov/mp/cvp/) and [state water project](https://water.ca.gov/Programs/State-Water-Project) under alternative infrastructure, regulatory, operational, and climate scenarios.   calsim is used to help answer engineering and scientific questions and is common input to biologic, economic, groundwater, hydrodynamic, and hydropower models
