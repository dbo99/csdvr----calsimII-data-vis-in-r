# :earth_asia: **csdvr** :earth_americas: #  
 ...
 `csdvr` summarizes `calsim` output in [R](https://www.r-project.org/) | analyze large numbers of variables or scenarios or batch export plots (jpg, interactive [html](https://plot.ly/r/), pdf, etc) 
