# :earth_asia: **csdvr** :earth_americas: #  
 ...
 `csdvr` summarizes `calsim` output in [R](https://www.r-project.org/) | quickly visualize or batch export plots (eg png, interactive [html](https://plot.ly/r/), pdf, etc)  | easily apply popular R data visualization functions on large amounts of calsim output
