...
- as needed spell other name/nickname descriptions for dvs in varcodes.csv - only a few mapped currently, eg "Jones (CVP)" for "d419". some plots label the `dv`, the actual calsim name, and other `dv_names', hte nickname. switch or make more as necessary.
