...
`control.r`  | action
------------ | -------------
`1` | **reads in libraries,  functions, and csv data** (do first then sparingly as ~1/6 min read-in time per scenario) (~0.5 gb `.csv` each) (option to append sequentially in **`csv._list.r`**). 2a & 2b need 1 run first.
