# :earth_asia: **csdvr** :earth_americas: #  
 ...
 `csdvr` summarizes `calsim` output in [R](https://www.r-project.org/) | quickly visualize output distributions of interest or batch export plots (jpg, interactive [html](https://plot.ly/r/), pdf, etc) | accommodates large numbers of scenarios | applies common statistical R data visualization functions to calsim output
