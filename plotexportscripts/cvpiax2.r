...
# - commented out - cvp & swp shortages, though have similar dv names, theyre calculated differently
                  # swp is cumulative! - sounds like just would need SWP's december values..
