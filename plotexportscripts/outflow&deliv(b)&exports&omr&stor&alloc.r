...
setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
ggsave(paste0(paste(dvs,collapse="&"), "_sacwyt_bars.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("c406")
  ...
  pb_mn_scwyt2_perav_taf_d(df_diff) + ggtitle("Total Delta Outflow \n by Sacramento Water Year Type, Mean Differences From Baseline (82 water years)")+
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_sacwyt_bars_diffs.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("del_cvp_total_n", "del_cvp_total_s")
  ...
  pb_mn_ann_perav_taf(df)  + ggtitle("Mean Annual CVP Delivery, NOD (left) & SOD (right) (82 years)") + 
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm")) 
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_meanannperavbars.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("del_cvp_total_n", "del_cvp_total_s")
  ...
  pb_mn_ann_perav_taf_d(df_diff)  + ggtitle("Mean Annual CVP Delivery NOD & SOD, Difference from Baseline (82 years)")+
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm")) 
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_meanannperavbars_diff.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...
pb_mn_scwyt2_perav_taf(df) + ggtitle("Total CVP NOD Delivery \n by Sacramento Water Year Type Means (82 water years)")+
  theme(plot.margin=grid::unit(c(6,6,6,6), "mm")) 
setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
ggsave(paste0(paste(dvs,collapse="&"), "_sacwyt2_bars.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("del_cvp_total_n")
  ...
  pb_mn_scwyt_perav_taf_nolab(df) + ggtitle("Total CVP NOD Delivery \n by Sacramento Feb-Jan Water Year Type Means (81 water years)")+
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm")) 
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_sacwyt_bars_nolab.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("del_cvp_total_n")
  ...
  theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
 ggsave(paste0(paste(dvs,collapse="&"), "_sacwyt_bar_diffs.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("c406")
  ...
  p_monfacetw_excd_cfs_d(df_diff) + ggtitle("Total Delta Outflow, 984 months, difference from baseline") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_mongridexcdw_diff.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("c406")
  ...
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_mongridexcdgrid.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("c406")
  ...
  p_monfacetg_excd_cfs_d(df_diff) + ggtitle("Total Delta Outflow, 984 months, difference from baseline") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_mongridexcdgrid_diff.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("c408")
  ...
  p_monfacetw_excd_cfs(df) + ggtitle("Old and Middle River, 984 months") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm")) 
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_mongridexcdwrap.jpg"), dpi = 300, width = 17, height = 11, units = "in") 
...
{dvs <- c("c408")
  ...
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_mongridexcdwrap_diff.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...
p_mon_excd2_taf(df) + ggtitle("Trinity Storage, end of September (82 Septs)") +
  theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  
setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
ggsave(paste0(paste(dvs,collapse="&"), "_eoseptmonthly.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...
{dvs <- c("perdv_cvpag_sys")
  ...
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_MayAlloc.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...
dvs <- c("del_cvp_total_s")
  ...
  p_ann_fjwysum_scwyt_excd_taf(df) + ggtitle("Annual total: CVP SOD") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_2x3excdgrid.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  p_ann_fjwysum_scwyt_excd_taf(df) + ggtitle("Annual totals: CVP NOD & SOD by Sac WYT") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "2x3excdgrid.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  p_ann_fjwysum_scwyt_excd_taf_d(df_diff) + ggtitle("Annual total, CVP NOD & SOD by Sac WYT, difference from baseline") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_2x3excdgriddiff.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_2x3excdgrid_style2.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  p_ann_fjwysum_scwyt_excd2_taf_d(df_diff)  + ggtitle("CVP NOD & SOD by Sac WYT, difference from baseline") +
    ...
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_2x3excdgriddiff_style2.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  pr_ts_taf_d(df_diff, 1921, 2007, 0.005)  + ggtitle("Jones Pumping, difference from baseline") +
    ...
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_ridgediffs.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  prast_mon_ts_taf_d(df_diff)  + ggtitle("Jones Pumping, difference from baseline") +
    ...
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_monrastdiffs.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  prast_ann_ts_sum_taf_d(df_diff)  + ggtitle("Annual Jones Pumping, difference from baseline") +
    ...
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_annrastdiffs.jpg"), dpi = 300, width = 17, height = 11, units = "in")
...

{
  ...
  # order dv_names here. varcodes.csv defines these names - need to be in varcodes.csv first
  df$dv <- factor(df$dv, levels = c( "Trinity (CVP)"))
  
  
  z <- p_mon_ts_taf(df, 1921, 2004)   + ggtitle("Trinity Storage") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  z
...
}
{
  ...
  # order dv_names here. varcodes.csv defines these names - need to be in varcodes.csv first
  df$dv <- factor(df$dv, levels = c( "Shasta (CVP)"))
  
  
  z <- p_mon_ts_taf(df, 1921, 2004)   + ggtitle("Shasta Storage") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  z
...
}
{
  ...
  # order dv_names here. varcodes.csv defines these names - need to be in varcodes.csv first
  df$dv <- factor(df$dv, levels = c(  "Folsom (CVP)"))
  
  
  z <- p_mon_ts_taf(df, 1921, 2004)   + ggtitle("Folsom Storage") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  z
...

{
  ...
  # order dv_names here. varcodes.csv defines these names - need to be in varcodes.csv first
  df$dv <- factor(df$dv, levels = c( "CVP San Luis"))
  
  
   p_mon_ts_taf(df, 1921, 2004)   + ggtitle("CVP San Luis Storage") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
...
####### Timeseries Differences
{
 ...
 p_mon_ts_taf_d(df_diff, 1921, 2004)   + ggtitle("Shasta Storage, Difference") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
...
######## Stacked Sequential Bars #####################

{
dvs <- c("s4")
pb_eomay_stor_scwyt_taf(df) + ggtitle("End of May Shasta Storage, by Sac WYT") +
  theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
  theme(strip.text.y = element_text(angle = 0))
setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))

ggsave(paste0(paste(dvs,collapse="&"), "_eomay_storage.jpg"), dpi = 300, width = 17, height = 11, units = "in")
setwd(here())
}
...
{
  dvs <- c("s4")
pb_eomay_stor_scwyt_taf_d(df_diff) + ggtitle("End of May Shasta Storage [Difference], by Sac WYT") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_eomay_storagediffs.jpg"), dpi = 300, width = 17, height = 11, units = "in")
  setwd(here())
...
{
  dvs <- c("s4")
pb_eosep_stor_scwyt_taf(df) + ggtitle("End of Sept Shasta Storage, by Sac WYT") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))
  ggsave(paste0(paste(dvs,collapse="&"), "_eosep_storage.jpg"), dpi = 300, width = 17, height = 11, units = "in")
  
}

{
  dvs <- c("s4")
pb_eosep_stor_scwyt_taf_d(df_diff) + ggtitle("End of Sept Shasta Storage [Difference], by Sac WYT") +
    theme(plot.margin=grid::unit(c(6,6,6,6), "mm"))  + 
    theme(strip.text.y = element_text(angle = 0))
  setwd(here("plots", "outflow&deliv(b)&exports&omr&stor&alloc"))

  ggsave(paste0(paste(dvs,collapse="&"), "_eosep_storagediffs.jpg"), dpi = 300, width = 17, height = 11, units = "in")
